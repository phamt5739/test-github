...
namespace ShopPizzaHut.Areas.Admin.Controllers
{
    public class NhanVienController : BaseController
    {
        ...
        {
            ViewBag.MaCV = new SelectList(db.ChucVuNhanViens, "MaChucVu", "TenChucVu");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MaNV,TenNV,MaCV,DiaChi,DienThoai,Image")] NhanVien nhanVien)
        {
            ...
            ViewBag.MaCV = new SelectList(db.ChucVuNhanViens, "MaChucVu", "TenChucVu", nhanVien.MaCV);
            return View(nhanVien);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNV,TenNV,MaCV,DiaChi,DienThoai,Image")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
