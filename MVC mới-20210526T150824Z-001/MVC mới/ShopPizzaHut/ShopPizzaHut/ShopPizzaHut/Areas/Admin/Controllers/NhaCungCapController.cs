...
namespace ShopPizzaHut.Areas.Admin.Controllers
{
    public class NhaCungCapController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "MaNhaCC,TenNhaCC,DiaChiNhaCC,DienThoaiNhaCC")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNhaCC,TenNhaCC,DiaChiNhaCC,DienThoaiNhaCC")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
